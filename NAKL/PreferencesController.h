...
@interface PreferencesController : NSWindowController {
    __weak SRRecorderControl *_toggleHotKey;
    __weak SRRecorderControl *_switchMethodHotKey;
    NSString *versionString;
    NSArrayController *shortcuts;
    IBOutlet NSTableView *shortcutsTableView;
}

@property (nonatomic, readwrite, weak) IBOutlet SRRecorderControl *toggleHotKey;
@property (nonatomic, readwrite, weak) IBOutlet SRRecorderControl *switchMethodHotKey;
